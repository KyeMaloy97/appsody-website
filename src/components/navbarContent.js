...
import searchIcon from "../images/search_16.svg";
  ...
  <React.Fragment>
    ...
    <Navbar.Collapse id="basic-navbar-nav">
      ...
      <Nav className="ml-auto">
        <Search/>
        <Nav.Link href="/"><img className="navbar-img search-icon d-sm-block d-md-none d-lg-none" style={{width: "22px", height: "22px"}} src={ searchIcon } alt=""></img></Nav.Link>
